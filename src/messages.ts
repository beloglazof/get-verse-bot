...
export const SET_BOOKMARK_MESSAGE = `Отправьте мне ссылку с [vedabase](${VEDABASE_LIBRARY_BASE_URL}) или с [gitabase](${GITABASE_LIBRARY_BASE_URL}) на стих на котором Вы остановились`;
